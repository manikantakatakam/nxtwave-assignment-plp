  ...
  return (
    <footer className="bg-black text-white pt-12 pb-4 px-4 md:px-8 lg:px-16">
      <div className="container mx-auto">
        {isMobile ? (
          <div className="mb-10">
            <h3 className="text-xl font-bold uppercase text-center">Be the first to know</h3>
            ...
            <div className="mt-10 border-t border-white/20 pt-5">
              ...
              >
                ...
                <ChevronDown className={`w-4 h-4 transition-transform ${openSection === 'metta' ? 'rotate-180' : ''}`} />
              </button>
              
              {openSection === 'metta' && (
                <nav className="mt-2 pl-2 space-y-3">
                  <a href="/about" className="block">About Us</a>
                  <a href="/stories" className="block">Stories</a>
                  <a href="/artisans" className="block">Artisans</a>
                  <a href="/boutiques" className="block">Boutiques</a>
                  <a href="/contact" className="block">Contact Us</a>
                  <a href="/compliance" className="block">EU Compliance Docs</a>
                </nav>
              )}
            </div>
            ...
            <div className="border-t border-white/20 pt-3">
              ...
              >
                ...
                <ChevronDown className={`w-4 h-4 transition-transform ${openSection === 'quick' ? 'rotate-180' : ''}`} />
              </button>
              
              {openSection === 'quick' && (
                <nav className="mt-2 pl-2 space-y-3">
                  <a href="/shipping" className="block">Orders & Shipping</a>
                  <a href="/seller" className="block">Join/Login as a Seller</a>
                  <a href="/payment" className="block">Payment & Pricing</a>
                  <a href="/returns" className="block">Return & Refunds</a>
            ...
            <div className="border-t border-white/20 pt-3">
              ...
              >
                ...
                <ChevronDown className={`w-4 h-4 transition-transform ${openSection === 'follow' ? 'rotate-180' : ''}`} />
              </button>
            ...
            <div className="border-t border-white/20 pt-3">
              <button 
                onClick={() => toggleSection('accepts')}
                className="flex items-center justify-between w-full py-3"
              >
                <h3 className="text-xl font-bold uppercase">mettā muse Accepts</h3>
                <ChevronDown className={`w-4 h-4 transition-transform ${openSection === 'accepts' ? 'rotate-180' : ''}`} />
              </button>
              
              {openSection === 'accepts' && (
                <div className="mt-3 pl-2 flex flex-wrap gap-2">
                  <div className="bg-white text-black w-12 h-8 rounded flex items-center justify-center text-xs">
                    <img src="/lovable-uploads/gpay.png" alt="Google Pay" className="h-6" />
                  </div>
                  <div className="bg-white text-black w-12 h-8 rounded flex items-center justify-center text-xs">
                    <img src="/lovable-uploads/mastercard.png" alt="Mastercard" className="h-6" />
                  </div>
                  <div className="bg-white text-black w-12 h-8 rounded flex items-center justify-center text-xs">
                    <img src="/lovable-uploads/paypal.png" alt="PayPal" className="h-6" />
                  </div>
                  <div className="bg-white text-black w-12 h-8 rounded flex items-center justify-center text-xs">
                    <img src="/lovable-uploads/amex.png" alt="American Express" className="h-6" />
                  </div>
                  <div className="bg-white text-black w-12 h-8 rounded flex items-center justify-center text-xs">
                    <img src="/lovable-uploads/applepay.png" alt="Apple Pay" className="h-6" />
                  </div>
                </div>
              )}
            </div>
